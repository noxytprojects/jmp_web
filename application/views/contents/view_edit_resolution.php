    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card has-shadow">
                ...
                <div class="card-body">
                    <form action="<?php echo site_url('resolutions/submiteditresolutution/'. $res['res_id']); ?>" method="post" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input name="res_number" placeholder="Enter the resolution number" value="<?php echo  !empty(set_value('sbt')) ? set_value('res_number') : $res['res_number'];//echo $res['res_number']; ?>" class="form-control"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <select name="res_type_id" style="width:100%" class="form-control">
                                    <option value=""></option>
                                    <?php
                                    $res_type_id = !empty(set_value('sbt'))? set_value('res_type_id') : $res['res_res_type_id'] ;
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <textarea rows="3" name="res_desc_en"    placeholder="Enter Resolution SMS in English" class="form-control <?php echo!empty(form_error('res_desc_en')) ? 'is-invalid' : ''; ?>"><?php echo !empty(set_value('sbt'))? set_value('res_desc_en') : $res['res_sms_en']; ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <textarea rows="3" name="res_desc_sw"  placeholder="Enter Resolution SMS in Swahili" class="form-control <?php echo!empty(form_error('res_desc_sw')) ? 'is-invalid' : ''; ?>"><?php echo !empty(set_value('sbt'))? set_value('res_desc_sw') : $res['res_sms_sw']; ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <div class="row">
                                    <?php $qn_type = !empty(set_value('sbt')) ? set_value('qn_type') : $qn_type?>
                                    <div class="col-sm-12">
                                        <div>
                                            <input id="yesorno" <?php echo ($qn_type == 'YESNO') ? 'checked="checked"' : ''; ?> type="radio" value="YESNO" name="qn_type">
                                            <label for="yesorno">YES/NO</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div>
                                            <input id="multiple" <?php echo ($qn_type == 'MULTI') ? 'checked="checked"' : ''; ?> type="radio" value="MULTI" name="qn_type">
                                    ...
                                    <div class="col-sm-12">
                                        <div>
                                            <input id="ms" <?php echo ($qn_type == 'MS') ? 'checked="checked"' : ''; ?> type="radio" value="MS" name="qn_type">
                        ...
                        <br/>
                        <div id="choices" class="form-group row <?php echo ($qn_type == 'MULTI' OR $qn_type == 'MS') ? '' : 'hide'; ?>">
                            <label class="col-sm-3 form-control-label">Resolution Answer Choices</label>
                            <div class="col-sm-9 input-field">
                                <?php
                                if (!empty(set_value('letter[]')) OR !empty($choices)) {

                                    $letters = !empty(set_value('sbt')) ? set_value('letter[]') : array_column($choices, 'choice_letter');
                                    $qn_desc_en = !empty(set_value('sbt')) ? set_value('qn_desc_en[]') :array_column($choices, 'choice_description_en') ;
                                    $qn_desc_sw = !empty(set_value('sbt')) ? set_value('qn_desc_sw[]') : array_column($choices, 'choice_description_sw');
                        ...
                        <div id="ms_max" class="form-group row <?php echo ($qn_type == 'MS')? '' : 'hide'; ?>">
                            ...
                            <div class="col-sm-9 input-field">
                                <input name="max_selection" value="<?php echo !empty(set_value('sbt'))? set_value('max_selection') : $res['res_max_selection'];?>" class="form-control"/>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 offset-sm-3">
                                <button type="submit" name="sbt" class="btn btn-primary">Save Resolution</button>
                            </div>
                        </div>
                    </form>
                </div>
