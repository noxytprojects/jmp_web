            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body no-padding">
                                <canvas id="marketCapGraph" width="400" height="150"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body no-padding">
                                <canvas id="turnoverGraph" width="400" height="150"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body no-padding">
                                <canvas id="pricetimeGraph" width="400" height="150"></canvas>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.simple-marquee-container').SimpleMarquee({duration:120000});
