        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="btn-group pull-right" role="group" aria-label="Basic example">
                    <a href="<?php echo site_url('trip/requesttrip') ?>" class="btn btn-info btn-sm"><i class="fa fa-plus-circle"></i>&nbsp;Request A Trip</a>
                </div>
            </div>
        </div>
        <br/>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#cds_acc_table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('trip/ajaxtriprequests'); ?>",
                data: {type: ""},
                "type": "POST",
