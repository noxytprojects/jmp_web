        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="btn-group pull-right" role="group" aria-label="Basic example">
                    <a href="<?php echo site_url('reports/pdfexportattendencesummary'); ?>" target="_blank" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Export PDF</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body no-padding">
                        <table  class="table table- table-bordered " style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>TOTAL SHAREHOLDERS ATTENDED</th>
                                    <td><?php echo cus_price_form($shareholders_attendance); ?></td>
                                </tr>
                                <tr>
                                    <th>TOTAL PROXIES ATTENDED</th>
                                    <td><?php echo cus_price_form($proxy_attendance); ?></td>
                                </tr>
                                <tr>
                                    <th>TOTAL ATTENDEES</th>
                                    <td><?php echo cus_price_form(($shareholders_attendance + $proxy_attendance)); ?></td>
                                </tr>
