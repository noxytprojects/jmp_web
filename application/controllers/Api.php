...
class Api extends CI_Controller {
    ...
    function getRequestAndApprovalDetails($trip_id, $ad_name) {
        ...
        $approvals = $this->approval->getRequestApprovals(['ap.ap_comments', 'sec_tl_full_name ao.ao_full_name', 'sec_tl_email ao.ao_email', 'ap.ap_status', 'ap.ap_tr_id', 'ap.ap_ad_name'], ['ap.ap_tr_id' => $trip['tr_id']]);
